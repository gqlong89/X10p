...
#endif
#if defined  HT501x  || HT502x  || HT6x2x  ||  HT6x3x
...
#endif
#if  defined  HT6x3x
    __IO uint32_t INFOLOCK;                 /*!< Offset: 0x050 Info Flash锁定寄存器A             (R/W)  */
                                            /*!<           对应HT6x3x手册中INFOLOCK_A                   */
...
typedef struct
{
    ...
    __I  uint32_t Reserved[2];
    __IO uint32_t Filt;                     /*!< Offset: 0x02C 输入模拟滤波控制寄存器(R/W) */
...
#if defined  HT6x2x  ||  defined  HT6x3x  || HT502x
...
#define  SPI_SPICLKSEL_SPIMODE                   ((uint32_t)0x0080)           /*!<SPI辅助分频使能位      */
#endif
...
#if  defined  HT6x3x
#define  LCD_LCDCLK_LCLK_DIV8                    ((uint32_t)0x0003)           /*!<Divide Radio = 8      */
#define  LCD_LCDCLK_LCLK_DIV16                   ((uint32_t)0x0002)           /*!<Divide Radio = 16     */
#define  LCD_LCDCLK_LCLK_DIV32                   ((uint32_t)0x0001)           /*!<Divide Radio = 32     */
#define  LCD_LCDCLK_LCLK_DIV64                   ((uint32_t)0x0000)           /*!<Divide Radio = 64     */
#define  LCD_LCDCLK_LCLK_DIV128                  ((uint32_t)0x0004)           /*!<Divide Radio = 128    */
#else
...
#endif
#if  defined  HT6x3x                                    
#define  PMU_PMUIE_LVD2IF                        ((uint32_t)0x0020)           /*!<LVDIN2检测中断标志    */
#endif
...
#endif
#if  defined  HT6x3x                                    
#define  PMU_PMUIE_LVD2FLG                       ((uint32_t)0x0020)           /*!<LVDIN2引脚电压状态    */
#endif
...
#elif  defined  HT6x2x
#define  CMU_CLKCTRL0                          ((uint32_t)0x01f3fe)         /*!<CLKCTRL0寄存器        */
#elif  defined  HT6x3x
